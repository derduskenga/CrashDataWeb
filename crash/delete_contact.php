	...
	if (isset($_REQUEST['id']) && $_REQUEST['id'] != '' && $_SESSION['user_level'] == "1") {
	  ...
	  mysql_query($query)or die(mysql_error());
		...
		//					"WHERE sys_casuality_id = '" . $_POST['id'] . "'";
			$query_delete = "DELETE FROM emergency " .
		...
		//	$row = mysql_fetch_array($result_select);
			//echo "<a href=\"contacts.php\">click here</a> to go back to casualties information";
			
			//$_SESSION['user_logged'] = "";
			//$_SESSION['user_password'] = "";
			header("Refresh: 5; URL=contacts.php");
			echo "Contact has been deleted! " .
				 "You are being sent to the contacts area!<br>";
...
<title>Crash Data| Delete Contact</title>
...
<div id="main">
  ...
  <div id="center_info">
      ...
      <div id="div_delete">
        ...
        There is no way to retrieve this contact once you confirm!<br>
